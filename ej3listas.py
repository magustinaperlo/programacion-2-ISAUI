...
# por pantalla con el mensaje En <asignatura> has sacado
# <nota> donde <asignatura> es cada una des las asignaturas de la
# lista y <nota> cada una de las correspondientes notas introducidas por el
# usuario.

asignaturas=["Matematicas","Fisica","Quimica","Historia", "Lengua" ]
notas=[]
for i in asignaturas:
    nota =input("Ingrese su nota en "+ i +" = ")
    notas.append(nota)
